...
def arg_parser():
    ...
    parser.add_argument('--feature_file', type=str, default='feat_files/LIVE-Meta-Mobile-Cloud-Gaming_GAMIVAL_feats.mat')
    parser.add_argument('--out_file', type=str, default='feat_files/LIVE-Meta-Mobile-Cloud-Gaming_GAMIVAL_feats')
    parser.add_argument('--predicted_score', type=str)
    parser.add_argument('--best_parameter', type=str)
    parser.add_argument('--log_file', type=str, default='logs/LIVE-Meta-Mobile-Cloud-Gaming_GAMIVAL_predict.log')
